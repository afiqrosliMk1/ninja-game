...
class Cloud:
    ...
    def render(self, surf, offset=(0, 0)):
        #depth gives parallax effect
        render_pos = (self.pos[0] - offset[0] * self.depth, self.pos[1] * self.depth)
        #modulo gives a way to loop the clouds
...
class Clouds:
    def __init__(self, cloud_images, count=16):
        ...
        #this an advance way of sorting, closest to camera will be pushed to the front
